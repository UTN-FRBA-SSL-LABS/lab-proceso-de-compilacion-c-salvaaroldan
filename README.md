...
> **R:** Porque tiene mas de una directiva, tiene 2 librerias definidas y un archivo extra, que pertenece al directorio del proyecto.
...
> **R:** No devuelve nada por el funcionamiento del comando en si. Si no encuentra nada no devuelve nada y termina su proceso sin avisos. 
...
> **R:** El primero no muestra nada, el segundo muestra: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:**Indican que se utiliza el archivo stdio.h para las lineas que le siguen al # en el archivo programa.c; el printf proviene del stdio.h
...
> **R:**Porque las funciones estan definidas en matematica.c y programa.c solo las llama
...
> **R:**Son funciones de la biblioteca dinamica que quedan en el ejecutable final. Los resuelve el cargador dinamico cuando se ejecuta el programa
...
> **R:**La funcion macro "desaparece" en el preprocesamiento, ya que es una directiva dirigida al procesador y no al compilador. La que tiene verificacion de tipos es la funcion real.
...
> **R:** El tipo T indica que la funcion existe en la seccion 'text' del archivo, le codigo ejecutable, mientras que D (que tambien significa definido) indica que se almacena en la seccion data.
